...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "boost-1.85.0"
  WORKING_DIRECTORY "/Users/morbo/CLionProjects/prologix_emulator/_deps/boost-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/morbo/CLionProjects/prologix_emulator/_deps/boost-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/morbo/CLionProjects/prologix_emulator/_deps/boost-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
