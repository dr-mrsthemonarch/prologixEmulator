...
////session class to allow multiple connections of clients seperated from each other.
//
//
//
//
//    TCPSession::TCPSession(ip::tcp::socket socket, Command& cmd) : socket_(std::move(socket)), command_(cmd) {}
//
